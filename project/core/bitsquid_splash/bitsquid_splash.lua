...
local colors = {
	black = function() return Color(0, 0, 0) end,
	white = function() return Color(255, 255, 255) end,
	burgundy = function() return Color(108, 18, 52) end,
	teal = function() return Color(100, 193, 200) end
}
...
local function logo_tiles_high_quality()
	...
	local p1 = {}
	local p2 = { tl, bl, cp, bl, br, cp, br, tr, cp, tr, tl, cp }
	local p3 = { tl, bl, cp, bl, br, cp }
	local p4 = { tl, bl, cp, tr, tl, cp }
	local p5 = { tr, tl, cp, br, tr, cp }
	local p6 = { bl, br, cp, br, tr, cp }
...
function BitsquidSplash.create(viewport_template_name, shading_environment_name, high_quality, foreground_color, background_color)
	if high_quality == nil then high_quality = true end
...
function BitsquidSplash.render(splash)
	ShadingEnvironment.blend(splash.shading_environment, {"default", 1})
